...
<form action="?page=salvarPedido" method="POST">
    ...
    <div class="divzin" id="d1">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="id_produto" id="tfIdProduto" placeholder="Ex: 5454" readonly maxlength="4" oninput="fetch()" required
        ...
        <div class="mb-3">
            ...
            <input type="number" name="valor" id="tfValor" readonly pattern="[0-9]+" step="0.01" required>
        </div>
        <div class="mb-3">
            <label for="tfQuantidade">Quantidade:</label>
            <input type="number" name="quantidade" id="tfQuantidade" readonly pattern="[0-9]+" step="1" required
            value="<?php print $row->quantidade; ?>">
        </div>
        <div class="mb-3">
            <label for="tfSubtotal">Total:</label>
        ...
        <div class="mb-3">
            <label for="tfValor">Desconto (%):</label>
            <input type="number" name="desconto" id="desconto" pattern="[0-9]+" step="1" required>
        </div>
    ...
    <div class="mb-3">
        <button type="submit" class="btn btn-warning">Efetuar desconto <i class='fa-solid fa-percent'></i></button>
    </div>
    </div>
</form>
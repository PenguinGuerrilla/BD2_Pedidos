...
<?php
    ...
    print"<button onclick=\"location.href='?page=clientes'\" class='btn btn-success mb-3'> <i class='fa-solid fa-plus'></i> Cadastrar Cliente</button>";
    ...
    if($qtd > 0) {
        ...
        while($row = $res->fetch_object()) {
            ...
            <button onclick=\"location.href='?page=editarCliente&cpf=".$row->cpf."'\" class='btn btn-primary mb-1' >Editar <i class='fa-solid fa-pen-to-square'></i></button>
                ...
                class='btn mb-1 btn-danger'>Excluir <i class='fa-solid fa-trash'></i> </button>
            </td>";
            print "</tr>";
        }
        print"</table>";
